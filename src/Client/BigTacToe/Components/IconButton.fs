              ...
              (invalidate = true,
               ...
               paintSurface =
                   (fun args ->
                       ...
                       let xRatio = float32 info.Width / bounds.Width
                       let yRatio = float32 info.Height / bounds.Height
                       ...
                       canvas.DrawPath(path, new SKPaint(Color = SKColors.Black, IsAntialias = true))
                       ))
                ...
                FlexLayout.flexLayout [
                    ...
                    FlexLayout.Children [
                        ...
                        Label.label [
                            ...
                            Label.FontSize <| FontSize.Size 16.0
